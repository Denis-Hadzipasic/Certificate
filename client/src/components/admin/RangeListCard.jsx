...
export default function RangeListCard({ range }) {
  ...
  const deleteProduct = () => {
    axiosClient
      .delete(`range/deleteRange/${range._id}`)
      .then(() => {
            ...
            <div className="flex gap-3 justify-center">
              ...
              >
                <span className="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                  <NavLink to={`/admin/editCertificateRange/${range._id}`}>
                    <svg
        ...
        <div className="modal-box max-w-3xl">
          ...
          >
            ...
            <div>
              ...
              folgende Nummernkreis zu löschen!
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-center gap-8">
                ...
                <div className="flex flex-col gap-2">
                  <span className="font-medium">Hersteller Fl.Nr. von:</span>
                  <span className="text-center text-[20px]">
                    {range.manufacturerRangeStart}
                  </span>
                </div>
                <div className="flex flex-col gap-2">
                  <span className="font-medium">Hersteller Fl.Nr. bis:</span>
                  <span className="text-center text-[20px]">
              ...
              <span className="font-medium">
                Bitte beachten, dass die einmal gelöschte Nummernkreis nicht
