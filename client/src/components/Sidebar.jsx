          ...
          <div className="flex-1 mt-2 px-2 bg-white divide-y space-y-1">
            {/* {user.role === "user" ? ( */}
              <ul className="space-y-2 pb-2">
                ...
                <li
                  // className={user.leadRole[0] === "none" ? "hidden" : "visible"}
                >
                  <NavLink
